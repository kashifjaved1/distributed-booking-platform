...
namespace TicketService.Infrastructure.Outbox;

public class TicketOutboxService : IOutboxService
{
    private readonly TicketDbContext _dbContext;
    private readonly ILogger<TicketOutboxService> _logger;
    ...
    public TicketOutboxService(TicketDbContext dbContext, ILogger<TicketOutboxService> logger)
    {
